...
using SteffBeckers.MyProduct.MultiTenancy;
            ...
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<MyProductDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}SteffBeckers.MyProduct.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<MyProductDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}SteffBeckers.MyProduct.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<MyProductApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}SteffBeckers.MyProduct.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<MyProductApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}SteffBeckers.MyProduct.Application"));
            });
        }
    }
